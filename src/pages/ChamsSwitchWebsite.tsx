...
export default function ChamsSwitchWebsite() {
  return (
    <>
      ...
      <section className="section section--paper">
        <div className="container">
          <div className="section-head reveal">
            ...
            <p className="section-head__lede">From a single API to vertical-specific suites, the ChamsSwitch platform meets you where your business is.</p>
          </div>
        ...
        <div className="container reveal">
          <div className="cta-band">
            ...
            <div className="cta-band__actions">
              ...
              <a className="btn btn--outline-green" href="#partners">Become a Partner</a>
            </div>
          </div>
        </div>
      </section>
